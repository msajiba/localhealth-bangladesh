...
const Dms = () => {
    ...
    <Container>
        <Row className='mt-5'>
            <Col md={12}>
                 <h1 className='text-success text-center'> ( Diploma Medical Science ) <span> 3Years</span> </h1> 
                 <h5 className='text-justify'>  DMS (Diploma Medical Science) It is a long Training Program in our organization. It is started since 2006 on 1st time in cumilla . This 3 years medical course is very much needed for an educated unemployed youth to become self reliant. This course provides general knowledge training in all aspects of medical. D, M, S trainees will play an extraordinary role in first aid.</h5> 
              ...
              <div>
                ...
                <div>
                        <h4 className='text-success text-center mt-3'> ( Diploma Medical Science ) <span> 3Years</span> </h4> 
